...
params [
	...
	["_delay", 180],	// Seconds between waves.
	["_waveMax",999],		// Maximum Wave #
	["_spawnDist",1100]	// Spawning Distance
];
...
// PAVN
_side = EAST;
ZMM_EASTMan = ["vn_o_men_nva_01", "vn_o_men_nva_02", "vn_o_men_nva_03", "vn_o_men_nva_04", "vn_o_men_nva_05", "vn_o_men_nva_06", "vn_o_men_nva_07", "vn_o_men_nva_08", "vn_o_men_nva_09", "vn_o_men_nva_10", "vn_o_men_nva_11", "vn_o_men_nva_12"];
_Sentry = [];
_Team = [];
_Squad = [];
// _Truck = [configFile >> "CfgGroups" >> "East" >> "VN_PAVN" >> "vn_o_group_motor_nva" >> "vn_o_group_motor_nva_07"];
_Truck = [configFile >> "CfgGroups" >> "East" >> "OPF_T_F" >> "Motorized_MTP" >> "O_T_MotInf_Reinforcements"];
_Bicycle = "vn_o_bicycle_01";
_Light = "vn_o_wheeled_z157_mg_01";
_Medium = ["vn_o_wheeled_btr40_mg_02", "vn_o_wheeled_btr40_mg_01"];
_Heavy = ["vn_o_armor_m41_01", "vn_o_armor_type63_01"];
_AA = ["vn_o_wheeled_z157_mg_02", "vn_o_wheeled_btr40_mg_03"];
_Air = [];
//_CAS = "vn_o_air_mi2_04_06", "vn_o_air_mi2_04_02", "vn_o_air_mi2_04_04", "vn_o_air_mi2_05_06", "vn_o_air_mi2_05_02", "vn_o_air_mi2_05_04", "vn_o_air_mi2_03_06", "vn_o_air_mi2_03_04";
...
zmm_fnc_spawnUnit = {
	...
	if (_unitClass isEqualType "") then {
		...
		(vehicle (leader _grpVeh))  enableDynamicSimulation true;
	...
	if (_sleep) then { sleep random 10 };
};
	...
	switch (_wave) do {
		case 1: {
			for [{_i=0}, {_i < 5},{_i= _i + 1}] do {
				[_location, _spawns, _side, _Bicycle] call zmm_fnc_spawnUnit;
			};
		};
		case 2: {
		...
		case 4: {
			[_location, _spawns, _side, _AA] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, _AA] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, _AA] call zmm_fnc_spawnUnit;
		};
		case 5: {
			...
			[_location, _spawns, _side, _Light] call zmm_fnc_spawnUnit;			
			[_location, _spawns, _side, _Light] call zmm_fnc_spawnUnit;
		};
		case 6: {
			[_location, _spawns, _side, _Medium] call zmm_fnc_spawnUnit;			
			[_location, _spawns, _side, _Light] call zmm_fnc_spawnUnit;
		};
		case 7: {
			[_location, _spawns, _side, _Medium] call zmm_fnc_spawnUnit;			
		...
		case 8: {
			[_location, _spawns, _side, _Heavy] call zmm_fnc_spawnUnit;
		};
		default {
			for [{_i=0}, {_i < 5},{_i= _i + 1}] do {
				[_location, _spawns, _side, _Bicycle] call zmm_fnc_spawnUnit;
